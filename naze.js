...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: fs.readFileSync('./media/image/naze.jpg'), caption: `*Pembayaran Yang Kami Dukung*\n
     ┏━━━━━━━━━━━━━━━━\n
     ┣ *Dana* - 089653457526\n
     ┣ *Gopay* - 089653457526\n
     ┣ *Bank Bca* - 1260766011\n"
     ┣ *Qriz Dana* - https://telegra.ph/file/b6478356bc70b75d64666.jpg\n
     ┣ *Semua Atas Nama* - IxxxL FxxxR IxxxxI\n
     ┗━━━━━━━━━━━━━━━━\n }`, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6289653457526')
            }
            break		 
            case 'subsyt': {
...
rules = `╭──❍ *Rules BOT*
│
│ *Intinya Plonco adik kandung UUK❗*
│
╰────❍`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Mendem' }, type: 1 }]
